...
import RPC call and node 0 sends Mydoge to it. Then other nodes import the
...
In the second part of the test, node 0 sends more Mydoge to each address, and the

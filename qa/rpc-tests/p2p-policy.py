...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Mydogecoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in MYDOGE
        ten = Decimal("10.0")                  # uniform 10 MYDOGE seed moneys
        ...
        # create a bunch of UTXO with seed money from the Mydogecoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 MYDOGE output and 1 MYDOGE fee
    ...
    # spend seed money with a key not in the Mydogecoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Mydogecoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Mydogecoin Core, to test

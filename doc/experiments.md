...
built Mydogecoin Core deployments.
...
3. The feature shall call the `MYDOGECOIN_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `MYDOGECOIN_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to

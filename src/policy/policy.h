...
/** Recommended transaction fee by Mydogecoin Core developers
  *
 ...
 *
 *  Mydogecoin:    Increment mempool limits and accept RBF in steps of 0.0001 MYDOGE
...
/**
 * Mydogecoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Mydogecoin: Default hard dust limit that is evaluated when considering whether

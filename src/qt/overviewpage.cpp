...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Mydogecoin Core repository on GitHub"),
        tr("Services that claim to double your mydogecoins are always ponzi schemes")
    };

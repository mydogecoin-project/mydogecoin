...
// Copyright (c) 2020-2023 The Mydogecoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Mydogecoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Mydogecoin (as there is no actual maximum coins)

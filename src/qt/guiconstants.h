...
#define QAPP_ORG_NAME "Mydogecoin"
#define QAPP_ORG_DOMAIN "mydogecoin.org"
#define QAPP_APP_NAME_DEFAULT "Mydogecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Mydogecoin-Qt-testnet"
